package com.example.thingfinding.firstLauncher;
...
public class FirstLauncherActivity extends AppCompatActivity{
    ...
    //图片数组
    private int[] images=new int[]{R.drawable.yindaoye1,R.drawable.yindaoye2,R.drawable.yindaoye3};
    ...
    private void gotoMain(){
        ...
        Intent intent=new Intent(FirstLauncherActivity.this,TestActivity.class);
